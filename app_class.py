...
pygame.init()
logo = pygame.image.load('main1.png')
...
class App:
    def __init__(self):
        ...
        self.bfs_button = Buttons(self, WHITE, 265, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Breadth-First Search')
        self.dfs_button = Buttons(self, WHITE, 480 , MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Depth-First Search')
        self.astar_button = Buttons(self, WHITE, 690, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'A-Star Search')
        self.dijkstra_button = Buttons(self, WHITE, 900, MAIN_BUTTON_Y_POS, MAIN_BUTTON_LENGTH, MAIN_BUTTON_HEIGHT, 'Dijkstra Search')
...
##### Loading Images
    def load(self):
        self.main_menu_background = pygame.image.load('dark.jpg')
...
##### MAIN MENU FUNCTIONS
    ...
    def main_menu_events(self):
        ...
        self.draw_text('Made By: Team B-10', self.screen, [1200, 720], 28, WHITE, FONT, centered=True)
